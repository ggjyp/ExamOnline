...
<body>
<div id="reg">
    <FORM name="formUser"  action="/jsp/user/register/successed"  method=post>
        <BR>
        <TABLE width="100%" align=center border=0>
            ...
            <TR>
                ...
                <TD><INPUT id="email" onBlur="checkEmail(this)" name="userEmail">
                    <SPAN id=email_notice >*</SPAN></TD>
            </TR>
            <TR>
                <TD align=right><STRONG>密码:</STRONG></TD>
                <TD><INPUT id="password" onBlur="checkPassword(this)"
                           onkeyup="checkIntensity(this.value)" type="password" name="userPwd">
            <SPAN
