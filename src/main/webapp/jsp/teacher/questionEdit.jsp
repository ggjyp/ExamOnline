    ...
    <div class="admin-content">
        ...
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">学科管理</strong> / <small>编辑学科</small></div>
            </div>
            ...
            <div class="am-tabs am-margin" data-am-tabs>
                ...
                <div class="am-tabs-bd">
                    <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                        <form class="am-form" action="/jsp/admin/subject/edit" method="post">
                            <div class="am-g am-margin-top">
                                ...
                                <input type="text" class="am-input-sm" value="${subjectId}" name="subjectId" style="display: none">
                            </div>
